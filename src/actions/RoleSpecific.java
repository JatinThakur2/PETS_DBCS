...
* 
*/
public class RoleSpecific extends ListItem {
	...
	**********************************************************************************************/
	...
	// user interface	
	private Label theTitle = new Label("Role specific attributes");
	 ...
	 */
	public RoleSpecific(Group rolesControls, int x, int y, TabNames roles) {
		super(rolesControls, x, y, roles);
		xOffset = x;
		yOffset = y;
		setupLabelUI(theTitle, "Arial", 14, 100, Pos.BASELINE_LEFT, 690 + xOffset, 65 + yOffset);
		rolesControls.getChildren().add(theTitle);
	}
